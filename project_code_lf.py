...
dtree = DecisionTreeClassifier()                      #setting up a tree
dtree.fit(X_train,y_train)                            #using the train data to train the tree
y_pred = dtree.predict(X_test)                   #making predicitons on the test data
...
rfc = RandomForestClassifier(n_estimators=300)        #setting up a RFC with 300 estimators (number of randomly distributed trees classifing the object; default is 100)
rfc.fit(X_train,y_train)                              #using the train data to train the rfc
y_pred = rfc.predict(X_test)                     #making predicitons on the test data
from sklearn.metrics import classification_report,confusion_matrix#importing reporting methods
print('Random Forest')
print(classification_report(y_test, y_pred))
cm = confusion_matrix(y_test, y_pred)          #printing the confusion matrix 
...
#visualisation needs teh feature neames 
